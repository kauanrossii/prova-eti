...
public class AtualizarDestinoCommandHandler : IUseCase<AtualizarDestinoCommand, bool>
{
    ...
    public async Task<ResultDto<bool>> ExecutarAsync(AtualizarDestinoCommand requisicao,
        CancellationToken cancellationToken)
    {
        var destinoAntigo = await _context.Destinos.FindAsync([requisicao.Id], cancellationToken: cancellationToken);
